...
Consider several factors that are important when discussing the Definition of Done:
...
### Gate 1: The Team During Planning

![Gate 1](/files/gated_dod_1.png)

**The Design Review:** This gate establishes the DoD for the story or defect.  The Scrum Team assigned to work on the story or defect are responsible for working with the PO to accomplish the following:
...
6. After everything is accepted by the PO and the story is committed to by the team, the **Scrum Master** marks the story or defect as having completed Gate 1.

#### Deliverables

* Augmented VersionOne stories that include:
  * Refined definition of done with tailored testing requirements
  * Potentially impacted areas
  * Acceptance criteria
  * Record of Gate 1 completion

### Gate 2: The Team and Product Owner During Review (*The Informal Code Review*)

![Gate 2](/files/gated_dod_2.png)

**The Informal Code Review:**  This gate gives the team an opportunity to have the PO evaluate their work and whether it meets the DoD as outlined by the original review.
...
6. The **Product Owner** records definition of done completion, in Merge Request and signs-off on it.  **He/she** also records the completion of Gate 2 in the story/defect.
...
### Gate 3: The Tech Lead (Architect?) During Review (*The Formal Code Review*)

![Gate 3](/files/gated_dod_3.png)

**The Formal Code Review:** This gate gives the team an opportunity to have their work evaluated by a peer and receive constructive criticism on improvements that could be made in the future.  **This is not a gate that is meant to make the team go back and fix trivial issues.  Only major issues should prevent the story or defect from moving forward.**
...
### Gate 4: The Release Team

![Gate 4](/files/gated_dod_4.png)

**Zipping up our Dress Pants:** This gate allows the Release Team to validate that everything has been taken care of and to record the completion of the story or defect.
...
In the future, Woody will train everyone on what is necessary for a good threat model.  We won't go deep into what needs to be accomplished here, but the following points will help the reader understand the general use case for a threat model:

* What attackers are interested in attacking your feature, component or utility?
* Define all attack surfaces (ex. ports, APIs, data, etc.)
* Potentially create a Data Flow model.
