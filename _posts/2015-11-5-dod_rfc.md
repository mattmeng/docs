...
This gate gives the team an opportunity to have the PO evaluate their work and whether it meets the DoD as outlined by the original review.  Its purpose is to give the PO a chance to decide whether or not the work done meets the acceptance criteria and DoD.
